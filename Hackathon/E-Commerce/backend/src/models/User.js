...
const userSchema = new mongoose.Schema(
  {
    ...
    firstName: { type: String, required: [true, "Los nombres son obligatorios"], trim: true },
    lastName: { type: String, required: [true, "Los apellidos son obligatorios"], trim: true },
    idDocument: {
      type: String,
    ...
    birthDate: {
      ...
      validate: {
        validator: function (value) {
          return value < new Date(); // Fecha pasada
        },
